...
class Example:
    def __init__(self, viewer, options):
        ...
        block_shape = builder.add_shape_box(self.body_block, hx=hx, hy=hy, hz=hz, cfg=newton.ModelBuilder.ShapeConfig(density=mass/(8*hx*hy*hz)))
    ...
    def emit_particles(builder: newton.ModelBuilder, args):
        ...
        snow_particles = Example._spawn_particles(
            builder,
            args,
            particle_lo=np.array([-0.75, -0.5, 0.5]),
            particle_hi=np.array([-0.25, 0.5, 0.75]),
            density=300,
            flags=newton.ParticleFlags.ACTIVE,
        )
        ...
        mud_particles = Example._spawn_particles(
            builder,
            args,
            particle_lo=np.array([0.25, -0.25, 1.0]),
            particle_hi=np.array([0.75, 0.25, 1.5]),
            density=1000.0,
            flags=newton.ParticleFlags.ACTIVE,
        )
