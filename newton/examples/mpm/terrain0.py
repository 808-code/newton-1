...
if __name__ == "__main__":
    ...
    # Scene configuration
    parser.add_argument("--collider", default="none", choices=["cube", "wedge", "concave", "none"], type=str)
    parser.add_argument("--emit-lo", type=float, nargs=3, default=[-1, -1, 0])
    parser.add_argument("--emit-hi", type=float, nargs=3, default=[1, 1, 2.5])
